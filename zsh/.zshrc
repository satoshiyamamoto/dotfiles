...
alias ga='git add'
alias gb='git branch'
alias gcg='YSU_IGNORED_ALIASES=("g" "gf") && git fetch --prune && git switch main && git reset --hard origin/main && git branch -vv | awk "/: gone]/{print \$1}" | xargs --no-run-if-empty git branch --delete --force && unset YSU_IGNORED_ALIASES'
alias gc='git commit'
